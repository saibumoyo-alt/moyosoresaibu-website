  ...
  function setupForm(form,type){
    ...
    form.addEventListener('submit',async event=>{
      ...
      try{
        ...
        if(status){status.textContent=type==='field-notes'?'You’re on the Field Notes list. Thank you.':'Message sent. I aim to reply within two working days when a response is needed.';status.className='form-status success';}
